...
public class Aplic {
    public static void main(String[] args) {
        ...
        do{
             ...
             System.out.println("\n\nMedida da Altura: " + objRet.getAltura() + " " + objRet.getUnidade());
             System.out.println("Medida da Base: " + objRet.getBase() + " " + objRet.getUnidade());
             switch(opcao){ //passagem de mensagens
                 case 1 : System.out.println("A medida da área: " + objRet.calcArea() + " " + objRet.getUnidade());
                          break;
                 case 2 : System.out.println("A medida do perímetro: " + objRet.calcPerimetro() + " " + objRet.getUnidade());
                          break;
                 case 3 : System.out.println("A medida da diagonal: " + objRet.calcDiagonal()+ " " + objRet.getUnidade());
             }
        }while (opcao < 4);
    }    
}
